...
export class newMigration1616125622664 implements MigrationInterface {
    name = 'newMigration1616125622664'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `Client` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(30) NOT NULL, `email` varchar(300) NULL, `phone` varchar(30) NOT NULL, `celphone` varchar(45) NOT NULL, `isMayorist` tinyint NOT NULL, `hasNotification` tinyint NOT NULL, `status` tinyint NOT NULL, `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` datetime(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `state_id` int NULL, `municipality_id` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `Client` ADD CONSTRAINT `FK_d95590a1fb5590fcf614a573552` FOREIGN KEY (`state_id`) REFERENCES `State`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `Client` DROP FOREIGN KEY `FK_d95590a1fb5590fcf614a573552`");
